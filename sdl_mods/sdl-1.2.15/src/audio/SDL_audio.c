...
int SDLCALL SDL_RunAudio(void *audiop)
{
	...
	//if(checksound()){SDL_Delay(16);continue;}
...
//	printf("%s c urrent_audio %x driver_name %s \n",__FUNCTION__,current_audio,driver_name);
	return(0);
}
...
//	printf("%s audio->opened %d \n",__FUNCTION__,audio->opened);
